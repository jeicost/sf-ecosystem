  ...
  return (
    <div className="px-8 py-8 max-w-6xl">
      ...
      <div className="grid grid-cols-4 gap-3 mb-10">
        <StatCard label="Contenido Generado" value="47" hint="Piezas en 30 días" />
        <StatCard label="Alcance Estimado" value="24.5K" hint="Personas impactadas" />
        <StatCard label="Tiempo Ahorrado" value="18.5h" hint="Vs creación manual" />
        <StatCard label="ROI Proyectado" value="340%" hint="Basado en herramientas" />
      </div>
