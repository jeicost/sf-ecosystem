    ...
    <div className="px-8 py-8 max-w-6xl mx-auto">
      ...
      {activeTab === 'references' && (
        <div className="card p-6 text-center">
          ...
          <p className="text-xs text-[#444] mb-6">Aquí guardarás URLs, titles, y análisis de qué contenido funcionó bien en cada pilar.</p>
          <div className="bg-[#0F0F0F] border border-[#222] rounded-lg p-4 text-left text-xs text-[#888]">
            <p className="font-medium text-[#AAA] mb-2">🔧 En construcción</p>
            <p>Esta tabla será editable en la próxima versión. Por ahora puedes usar el Brand Brain para documentar:</p>
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>URLs de contenido que funciona</li>
              <li>Título y descripción</li>
              <li>Por qué funcionó</li>
              <li>Asignación a pilar</li>
            </ul>
          </div>
        </div>
      )}
