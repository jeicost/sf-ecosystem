    ...
    <div className="w-full">
      ...
      <div className="bg-black p-6 md:p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              {data.quarterly_okrs.map((q: any, qidx: number) => (
                <div key={qidx} className="border border-blue-500/30 bg-blue-500/5 p-4 rounded">
                  <div className="text-xs text-blue-400 font-bold mb-2">Q{q.q}</div>
                  {q.objectives && (
            ...
            <div className="space-y-4">
              {data['30_day_sprint'].focus && (
                <div className="border-l-4 border-green-500 bg-green-500/5 p-4 rounded-r">
                  <div className="text-xs text-green-400 font-bold mb-1">FOCUS</div>
          ...
          <section>
            ...
            <div className="space-y-4">
              {data['60_day_push'].focus && (
                <div className="border-l-4 border-yellow-500 bg-yellow-500/5 p-4 rounded-r">
                  <div className="text-xs text-yellow-400 font-bold mb-1">FOCUS</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {data.resource_requirements.budget && (
                <div className="border border-white/10 bg-white/5 p-4 rounded">
                  ...
                  <p className="text-sm text-green-400 font-bold">{data.resource_requirements.budget}</p>
                </div>
              )}
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {data.kpis.map((kpi: any, idx: number) => (
                <div key={idx} className="border border-white/10 bg-white/5 p-4 rounded">
                  ...
                  <div className="text-xs text-green-400">Target: {kpi.target}</div>
          ...
          <section>
            ...
            <div className="space-y-3">
              {data.risk_mitigation.slice(0, 5).map((risk: any, idx: number) => (
                <div key={idx} className="border-l-4 border-red-500 bg-red-500/5 p-4 rounded-r">
                  ...
                  <div className="text-xs text-green-400">Mitigation: {risk.mitigation}</div>
                </div>
              ))}
            </div>
          </section>
        ...
        {data.mission_alignment && (
          <div className="border-l-4 border-teal-500 bg-teal-500/5 p-4 rounded-r mt-8">
            <div className="text-xs text-teal-400 font-bold">✓ MISSION ALIGNMENT</div>
