...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    agents: [
      ...
      { emoji: '📢', name: 'Herald',  role: 'Brand Communicator' },
  ...
  },
  {
    ...
    highlights: [
      ...
      { icon: '🗺️', text: 'Atlas maps your competitive landscape; Spark scouts emerging trends' },
      { icon: '⚡', text: 'Together they help you stay ahead of the market and innovate faster' },
    ],
    agents: [
      ...
      { emoji: '🚀', name: 'Venture',   role: 'Business Developer' },
      { emoji: '🔮', name: 'Oracle',    role: 'Strategic Foresight' },
    ],
    quickWin: 'Tell Strategos where you are and where you want to be. Spark will spot the trends.',
  ...
  },
  {
    ...
    subtitle: 'You\'ve met all 30 agents across 5 departments. Strategy now includes innovation. They\'re standing by — you direct, they execute.',
    highlights: [
