  ...
  return (
    <div className="px-8 py-8">
      <div className="mb-6">
        ...
        <p className="text-[#555] mt-1 text-sm">{desc}</p>
      </div>
      <div className="rounded-2xl border border-dashed flex flex-col items-center justify-center py-20 px-8 text-center"
        style={{ background: '#09090e', borderColor: 'rgba(255,255,255,0.06)' }}>
        <div className="w-14 h-14 rounded-2xl flex items-center justify-center text-3xl mb-4"
          style={{ background: `${color}15`, border: `1px solid ${color}25` }}>
          {icon}
        </div>
        <p className="text-white font-semibold text-base mb-2">{title} — En configuración</p>
        <p className="text-sm max-w-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.3)' }}>{desc}</p>
