        ...
        {tools.map((tool) => (
          ...
          >
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs font-medium text-ink group-hover:text-ink transition-colors">{tool.name}</p>
            </div>
            <p className="text-[10px] text-ink-tertiary mb-2">{tool.description.substring(0, 60)}...</p>
            <div className="flex items-center justify-between">
              <span className="text-[9px] text-ink-muted">{tool.time}</span>
