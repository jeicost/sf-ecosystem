...
// Criterios del Ideal Customer Profile — la config que alimenta el scoring de
// Discovery, Scoring y Proposals (icp_profiles, una fila por cliente). Vivía
// como página propia en /comercial/icp; al ser configuración compartida sin
// flujo propio, ahora es la pestaña "Criterios ICP" dentro de Discovery.
...
export default function IcpCriteriaPanel() {
