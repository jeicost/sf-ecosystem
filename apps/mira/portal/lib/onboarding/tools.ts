  ...
  input_schema: {
    ...
    properties: {
      ...
      brand_data: {
        type: 'object',
        description:
          'Partial patch into the structured Brand Brain object. Only include what you have. Recognized keys: identity {name, tagline, one_liner, mission, vision, enemy}, what_it_is, value_proposition, competitive_positioning, tone_and_voice, visual_identity {status, colors {primary, secondary, accent, neutral, notes}, typography {heading_font, body_font, accent_font, notes}, logo {primary_url, notes}, imagery_style}, plus any other freeform key that captures something real (e.g. course_curriculum, bonus_items) that has no dedicated column.',
      },
    },
  },
}
