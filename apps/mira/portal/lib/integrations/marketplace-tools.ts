...
export const MARKETPLACE_TOOLS: MarketplaceTool[] = [
  ...
  },
  {
    ...
    emoji: '🚀',
    category: 'Sales',
    description: 'B2B contact database — powers Discovery "modo profundo" (real companies + contacts by ICP)',
    pricing: 'paid',
  ...
  },
  {
    ...
    emoji: '✉️',
    category: 'Sales',
    description: 'Verified email finder — confirms real, deliverable emails for Discovery "modo profundo"',
    pricing: 'paid',
