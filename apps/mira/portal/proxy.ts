...
export async function proxy(request: NextRequest) {
  ...
  if (pathname.startsWith('/login') || pathname.startsWith('/reset-password') || pathname.startsWith('/api/webhook') || pathname.startsWith('/api/debug') || pathname.startsWith('/api/fix') || pathname.startsWith('/api/diagnose') || pathname.startsWith('/api/schema') || pathname.startsWith('/api/load-data') || pathname.startsWith('/api/schema')) {
