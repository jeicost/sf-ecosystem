...
const contentDict: Record<Locale, {
  ...
  es: {
    ...
    description: "Descarga la plantilla gratuita de Startup Audit con IA que usamos en SF. Analiza tu modelo, tu mercado, tu equipo y tus métricas en 7 días con metodología propia.",
    ...
    subtitleNote: "La plantilla es gratuita. El agente IA está incluido.",
    ctaPrimary: "Descargar plantilla gratis", ctaSecondary: "Ver la metodología",
    receivesEyebrow: "Qué recibes", receivesH2: "No es un PDF genérico.\nEs el kit que usamos nosotros.",
    ...
    downloadEyebrow: "Acceso gratuito", downloadH2: "Empieza tu audit\n", downloadAccent: "esta semana.",
    downloadDesc: "Deja tu email y te enviamos la plantilla completa + el agente IA de análisis + el scorecard.",
    bridgeEyebrow: "¿Quieres que lo hagamos nosotros?", bridgeH2: "El audit propio tiene un límite.\n", bridgeAccent: "El de SF, no.",
    bridgeDesc: "Puedes hacer el audit solo con la plantilla. O puedes aplicar a SF y que nuestro equipo lo haga contigo — con contexto real del mercado, conexiones y un plan de acción que ejecutamos juntos.",
    bridgeCta1: "Aplica a SF — es gratis", bridgeCta2: "Prefiero la plantilla",
    stats: [{ n: "7", label: "áreas de análisis" }, { n: "7 días", label: "para completarlo" }, { n: "IA", label: "incluida en la plantilla" }],
    namePlaceholder: "Tu nombre", emailPlaceholder: "tu@email.com", startupPlaceholder: "¿Cómo se llama tu startup / proyecto?",
    submitBtn: "Enviarme la plantilla →", submitNote: "Gratis · Sin spam · Sin compromiso",
  },
  en: {
    title: "Startup Audit | Analyze your startup in 7 days with AI — Startup Factory",
    description: "Download the free Startup Audit template with AI that we use at SF. Analyze your model, market, team and metrics in 7 days with our own methodology.",
    ...
    subtitleNote: "The template is free. The AI agent is included.",
    ctaPrimary: "Download template free", ctaSecondary: "See the methodology",
    ...
    downloadEyebrow: "Free access", downloadH2: "Start your audit\n", downloadAccent: "this week.",
    downloadDesc: "Leave your email and we'll send you the complete template + the AI analysis agent + the scorecard.",
    bridgeEyebrow: "Want us to do it with you?", bridgeH2: "The self-audit has its limits.\n", bridgeAccent: "The SF audit doesn't.",
    bridgeDesc: "You can do the audit alone with the template. Or you can apply to SF and have our team do it with you — with real market context, connections and an action plan we execute together.",
    bridgeCta1: "Apply to SF — it's free", bridgeCta2: "I prefer the template",
    stats: [{ n: "7", label: "analysis areas" }, { n: "7 days", label: "to complete it" }, { n: "AI", label: "included in the template" }],
    namePlaceholder: "Your name", emailPlaceholder: "your@email.com", startupPlaceholder: "What is your startup / project called?",
    submitBtn: "Send me the template →", submitNote: "Free · No spam · No commitment",
  },
  th: {
    title: "Startup Audit | วิเคราะห์ startup ของคุณใน 7 วันด้วย AI — Startup Factory",
    description: "ดาวน์โหลด template Startup Audit ฟรีพร้อม AI ที่เราใช้ใน SF วิเคราะห์ model ตลาด ทีม และ metrics ของคุณใน 7 วันด้วยวิธีการของเราเอง",
    ...
    subtitleNote: "Template ฟรี AI agent รวมอยู่ด้วย",
    ctaPrimary: "ดาวน์โหลด template ฟรี", ctaSecondary: "ดูวิธีการ",
    receivesEyebrow: "สิ่งที่คุณได้รับ", receivesH2: "ไม่ใช่ PDF ทั่วไป\nแต่คือ kit ที่เราใช้จริง",
    ...
    downloadEyebrow: "เข้าถึงฟรี", downloadH2: "เริ่ม audit ของคุณ\n", downloadAccent: "สัปดาห์นี้",
    downloadDesc: "ทิ้ง email ของคุณไว้และเราจะส่ง template ครบชุด + AI analysis agent + scorecard ให้คุณ",
    bridgeEyebrow: "ต้องการให้เราทำด้วยกันไหม?", bridgeH2: "การ audit เองมีข้อจำกัด\n", bridgeAccent: "ของ SF ไม่มี",
    bridgeDesc: "คุณสามารถทำ audit คนเดียวด้วย template หรือคุณสามารถสมัครที่ SF และให้ทีมของเราทำร่วมกับคุณ — พร้อม context ตลาดจริง การเชื่อมต่อ และแผนปฏิบัติการที่เราดำเนินการด้วยกัน",
    bridgeCta1: "สมัครที่ SF — ฟรี", bridgeCta2: "ฉันชอบ template",
    stats: [{ n: "7", label: "พื้นที่การวิเคราะห์" }, { n: "7 วัน", label: "เพื่อทำให้สมบูรณ์" }, { n: "AI", label: "รวมอยู่ใน template" }],
    namePlaceholder: "ชื่อของคุณ", emailPlaceholder: "your@email.com", startupPlaceholder: "startup / โปรเจกต์ของคุณชื่ออะไร?",
    submitBtn: "ส่ง template ให้ฉัน →", submitNote: "ฟรี · ไม่มี spam · ไม่มีความผูกมัด",
  },
};
