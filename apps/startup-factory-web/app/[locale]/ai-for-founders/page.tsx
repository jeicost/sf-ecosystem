...
const contentDict: Record<Locale, {
  ...
  es: {
    ...
    description: "Cómo usamos la IA en Startup Factory para validar, construir y operar proyectos reales. Cuéntanos el tuyo y te decimos por dónde empezar.",
    ...
    ctaPrimary: "Hablemos de mi proyecto →", ctaNote: "Sin tarjeta. Sin trampa. Una conversación.",
    kitEyebrow: "Cómo trabajamos", kitH2: "6 formas en que usamos la IA en proyectos reales",
    kitDesc: "Nada de teoría. Cada una la usamos en proyectos que están en marcha, y te contamos cuál encaja con el tuyo.",
    kitCta: "Ver si encaja con mi proyecto",
    whyEyebrow: "Por qué de SF", whyH2: "Construido por emprendedores", whyP1: "En Startup Factory llevamos dos años usando IA en proyectos reales — desde validar ideas hasta escalar operaciones con corporates como Mahou o Airbus.", whyP2: "Esto es lo que haríamos nosotros si empezáramos desde cero hoy. Sin las herramientas que no funcionan, sin la teoría que no convierte.",
    formEyebrow: "Sin coste", formH2: "Empieza a usar IA\n", formAccent: "esta semana.",
    formDesc: "Cuéntanos en qué estás y te escribimos en 48 horas con las dos o tres cosas concretas por donde empezaría alguien en tu situación.",
    ...
    submitBtn: "Hablemos →", privacyNote: "Sin spam. Solo te escribimos por esto. Nos tomamos tu privacidad en serio.",
  ...
  en: {
    ...
    description: "How we use AI at Startup Factory to validate, build and run real projects. Tell us about yours and we'll tell you where to start.",
    eyebrow: "AI for Founders · Startup Factory",
    ...
    ctaPrimary: "Let's talk about my project →", ctaNote: "No card. No tricks. A conversation.",
    kitEyebrow: "How we work", kitH2: "6 ways we use AI in real projects",
    kitDesc: "No theory. We use each one on projects that are running, and we'll tell you which fits yours.",
    kitCta: "See if it fits my project",
    whyEyebrow: "Why from SF", whyH2: "Built by entrepreneurs", whyP1: "At Startup Factory we've spent two years using AI in real projects — from validating ideas to scaling operations with corporates like Mahou or Airbus.", whyP2: "This is what we would do if we were starting from scratch today. Without the tools that don't work, without the theory that doesn't convert.",
    formEyebrow: "No cost", formH2: "Start using AI\n", formAccent: "this week.",
    formDesc: "Tell us where you are and we'll write back within 48 hours with the two or three concrete things someone in your situation should start with.",
    ...
    submitBtn: "Let's talk →", privacyNote: "No spam. We only write to you about this. We take your privacy seriously.",
  ...
  th: {
    ...
    description: "วิธีที่เราใช้ AI ใน Startup Factory เพื่อยืนยัน สร้าง และดำเนินโปรเจกต์จริง เล่าเรื่องโปรเจกต์ของคุณให้เราฟัง แล้วเราจะบอกว่าควรเริ่มตรงไหน",
    eyebrow: "AI for Founders · Startup Factory",
    h1: "AI ที่ไม่มีใคร\n", h1Accent: "กำลังสอนคุณ",
    subtitle: "วิธีที่เราใช้ AI จริงกับผู้ประกอบการที่ต้องการก้าวหน้าเร็วขึ้น — ไม่มีคอร์ส 80 ชั่วโมงหรือทฤษฎีเปล่า",
    subtitleNote: "ไม่มีค่าใช้จ่าย เป็นการพูดคุย",
    ctaPrimary: "คุยเรื่องโปรเจกต์ของฉัน →", ctaNote: "ไม่ต้องใช้บัตร ไม่มีเล่ห์เหลี่ยม แค่การพูดคุย",
    kitEyebrow: "วิธีที่เราทำงาน", kitH2: "6 วิธีที่เราใช้ AI ในโปรเจกต์จริง",
    kitDesc: "ไม่มีทฤษฎี เราใช้แต่ละวิธีในโปรเจกต์ที่กำลังดำเนินอยู่ และเราจะบอกว่าวิธีไหนเหมาะกับของคุณ",
    kitCta: "ดูว่าเหมาะกับโปรเจกต์ของฉันไหม",
    whyEyebrow: "ทำไมจาก SF", whyH2: "สร้างโดยผู้ประกอบการ", whyP1: "ที่ Startup Factory เราใช้ AI ในโปรเจกต์จริงมาสองปีแล้ว — ตั้งแต่การยืนยันไอเดียไปจนถึงการขยายการดำเนินงานกับองค์กรอย่าง Mahou หรือ Airbus", whyP2: "นี่คือสิ่งที่เราจะทำถ้าเริ่มจากศูนย์วันนี้ ไม่มีเครื่องมือที่ไม่ได้ผล ไม่มีทฤษฎีที่ไม่แปลงเป็นผล",
    formEyebrow: "ไม่มีค่าใช้จ่าย", formH2: "เริ่มใช้ AI\n", formAccent: "สัปดาห์นี้",
    formDesc: "เล่าให้เราฟังว่าคุณอยู่ตรงไหน เราจะตอบกลับภายใน 48 ชั่วโมง พร้อมสองสามสิ่งที่เป็นรูปธรรมที่คนในสถานการณ์ของคุณควรเริ่มทำ",
    ...
    submitBtn: "คุยกัน →", privacyNote: "ไม่มี spam เราจะติดต่อคุณเรื่องนี้เท่านั้น เราให้ความสำคัญกับความเป็นส่วนตัวของคุณ",
