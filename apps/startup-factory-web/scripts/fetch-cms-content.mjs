...
const PROJECT_SLUG = process.env.SF_CMS_PROJECT_SLUG || process.env.CMS_PROJECT || process.env.PROJECT_SLUG || 'startupsfactory' // client slug for SF-CMS authentication
