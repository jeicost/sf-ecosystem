...
Discovery/enrichment/scoring llaman a Claude directamente desde FastAPI (Tavily → Haiku → Supabase) — sin orquestador intermedio, mismo patrón que usa MIRA (`apps/mira/`).
