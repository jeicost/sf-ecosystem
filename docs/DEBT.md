...
- Verificar una sesión completamente autenticada en `mira/portal` post-upgrade con una credencial vigente (la de memoria de 2026-05-20 fue rechazada por Supabase, probablemente rotada).
