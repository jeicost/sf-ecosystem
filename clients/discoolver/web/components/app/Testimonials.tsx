 ...
 */
export function Testimonials({ content }: { content: AppHomeContent }) {
  const items = [1, 2, 3, 4, 5, 6].map((n) => ({
    quote: content[`testimonial_${n}_quote` as keyof AppHomeContent],
    name: content[`testimonial_${n}_name` as keyof AppHomeContent],
    role: content[`testimonial_${n}_role` as keyof AppHomeContent],
  }));
