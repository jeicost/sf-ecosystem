...
/**
 * Same accordion markup/classes as the home FAQ, but bound to the creators
 * copy (5 questions). Kept as its own component so the home stays untouched.
 */
export function InfluencerFaq({ content }: { content: InfluencersContent }) {
  ...
  return (
    <section className="section" id="faq" aria-labelledby="faq-creators-title">
      <div className="container">
        <Reveal delay={0}>
          <div className="section__head">
            <div className="section__head-text">
              <span className="eyebrow">{content.faq_eyebrow}</span>
              <h2 className="display-lg section__title" id="faq-creators-title">
        ...
        <div className="faq__list" role="list" aria-label="Preguntas frecuentes de creators">
          {items.map((item, i) => {
              ...
              <Reveal delay={i * 40} key={item.q}>
                <div role="listitem">
                  <button
                    ...
                    aria-controls={`faq-creators-answer-${i}`}
                    id={`faq-creators-question-${i}`}
                  ...
                  >
                    ...
                    <div className="faq__answer" id={`faq-creators-answer-${i}`} role="region" aria-labelledby={`faq-creators-question-${i}`}>
                      <p>{item.a}</p>
                    </div>
                  </button>
                </div>
