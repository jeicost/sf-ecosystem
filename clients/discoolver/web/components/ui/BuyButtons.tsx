...
const T = {
  es: {
    ...
    error: "No se pudo abrir el pago. Prueba otra vez o escribe a hello@discoolver.com.",
  ...
  en: {
    ...
    error: "Couldn't open checkout. Try again or write to hello@discoolver.com.",
