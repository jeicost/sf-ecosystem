...
export const defaultHomeContent = {
  ...
  hero_book_caption: "Madrid según Callejeando con Vera · Edición 2026",
  ...
  guide_1_city: "Madrid",
  guide_1_sub: "según Callejeando con Vera",
