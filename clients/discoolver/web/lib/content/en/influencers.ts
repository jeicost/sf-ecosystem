...
export const defaultInfluencersContent = {
  ...
  hero_line_1: "Your guide.",
  hero_line_2: "Your brand.",
  hero_line_3: "Your income.",
  hero_sub_a:
    "If you've built an audience, we edit your own city guide with you and you sell it under your name: you earn from every sale, plus commission on every booking.",
  hero_sub_b:
    "If you're just starting out, send us your best recommendation on video — the best ones make it into this year's guide. And they get paid.",

  // Track picker (two cards, right under the hero)
  picker_a_kicker: "I already have an audience",
  picker_a_title: "I want my guide",
  picker_a_text: "We edit your city guide with you. It goes out under your name and you earn from every sale.",
  picker_a_cta: "See how it works",
  picker_b_kicker: "I have recommendations",
  picker_b_title: "I'll send my video",
  picker_b_text: "Send us your best place on video. If it makes this year's guide, your byline goes inside and you get paid.",
  picker_b_cta: "See how it works",

  // Track TOP — creators with audience
  top_eyebrow: "Track 1 · Creators with an audience",
  ...
  top_step_1_label: "We import your spots",
  ...
  top_quote: "A reel lives 48 hours. Your guide lives all year.",
  ...
  micro_eyebrow: "Track 2 · You're just starting out",
  micro_title_1: "Send us",
  micro_title_em: "your video.",
  micro_lead:
    "You don't need a huge audience to make it into a guide. You need to know one place and tell it well.",
  micro_step_1_label: "Record your recommendation",
  micro_step_1_text: "Just like you already do: one place, why it's worth it, no posing.",
  micro_step_2_label: "Paste the link",
  ...
  micro_ladder: "The best names in each edition can end up with a guide of their own.",
  micro_cta: "Send my video",
  ...
  forms_title_1: "Tell us",
  forms_title_em: "who you are.",
  ...
  form_micro_note: "If it makes the guide, we'll write to you. If it doesn't, we'll write too — with the reason why.",
