...
export const defaultAppHomeContent = {
  ...
  categories_eyebrow: "The eight categories",
  categories_title: "The whole city,",
  categories_title_highlight: "sorted.",
  categories_lead:
    "Eight categories, the same ones across the platform, the guides and every city we open. Every place goes past an editor before it lands in one.",
  categories_cta: "Search the platform",
  cat8_restaurantes_name: "Restaurants and cafés",
  cat8_restaurantes_desc: "Where to actually eat, from lunch to the long afternoon.",
  cat8_nightlife_name: "Nightlife",
  cat8_nightlife_desc: "Drinks, music and the areas that wake up once everything else shuts.",
  ...
  cat8_experiencias_desc: "What only happens once, and what you need to book ahead.",
  cat8_compras_name: "Shopping and fashion",
  cat8_compras_desc: "Shops with a point of view, vintage, and what isn't on the main street.",
  cat8_alojamiento_name: "Where to stay",
  cat8_alojamiento_desc: "Somewhere to sleep that matches the trip: hotels, boutique and one-off houses.",
  cat8_wellness_name: "Wellness and beauty",
  cat8_wellness_desc: "Spas, self-care and the places where the city slows down.",
  cat8_naturaleza_name: "Nature and outdoors",
  cat8_naturaleza_desc: "Parks, trails and the countryside that starts where the tarmac ends.",
  cat_1_name: "Food",
